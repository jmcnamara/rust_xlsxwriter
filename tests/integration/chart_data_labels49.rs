...
fn create_new_xlsx_file(filename: &str) -> Result<(), XlsxError> {
    ...
    let data_labels1 = [ChartDataLabel::new().set_value("=Sheet1!$B$1").to_custom()];
    let data_labels2 = [ChartDataLabel::new()
        .set_value("=Sheet1!$B$2")
...
#[test]
fn test_chart_data_labels49() {
    let test_runner = common::TestRunner::new()
        .set_name("chart_data_labels49")

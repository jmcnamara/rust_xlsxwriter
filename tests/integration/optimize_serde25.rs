...
#[test]
fn test_optimize_serde25_1() {
    let test_runner = common::TestRunner::new()
        .set_name("table24")
        .set_function(create_new_xlsx_file_1)
        .unique("optimize_serde25_1")
...
#[test]
fn test_optimize_serde25_2() {
    let test_runner = common::TestRunner::new()
        .set_name("table24")
        .set_function(create_new_xlsx_file_2)
        .unique("optimize_serde25_2")
        .ignore_worksheet_spans()
        .initialize();
...
#[test]
fn test_optimize_serde25_3() {
    let test_runner = common::TestRunner::new()
        .set_name("table24")
        .set_function(create_new_xlsx_file_3)
        .unique("optimize_serde25_3")
        .ignore_worksheet_spans()
        .initialize();

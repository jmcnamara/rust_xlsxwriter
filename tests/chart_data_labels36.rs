...
use rust_xlsxwriter::{
    Chart, ChartDataLabel, ChartDataLabelPosition, ChartFont, ChartLine, ChartType, Workbook,
    XlsxError,
};
    ...
    chart
        ...
        .set_data_label(
            ChartDataLabel::new()
                ...
                .set_separator(';')
                .set_num_format("#,##0.00")
                .set_font(ChartFont::new().set_name("Consolas").set_pitch_family(49))
...
#[test]
fn test_chart_data_labels36() {
    let test_runner = common::TestRunner::new()
        .set_name("chart_data_labels36")

...
fn create_new_xlsx_file(filename: &str) -> Result<(), XlsxError> {
    ...
    chart
        .x_axis()
        .set_name("XXX")
        .set_font(ChartFont::new().set_name("Arial").set_pitch_family(34));
    chart
        .y_axis()
        .set_name("YYY")
        .set_font(ChartFont::new().set_bold().set_italic().set_underline());
...
#[test]
fn test_chart_font05() {
    let test_runner = common::TestRunner::new()
        .set_name("chart_font05")

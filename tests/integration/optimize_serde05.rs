...
fn create_new_xlsx_file_2(filename: &str) -> Result<(), XlsxError> {
    ...
    worksheet.serialize(&data1[0])?;
    worksheet.serialize(&data2[0])?;
    worksheet.serialize(&data1[1])?;
    worksheet.serialize(&data2[1])?;
    worksheet.serialize(&data1[2])?;

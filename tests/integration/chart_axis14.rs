...
fn create_new_xlsx_file(filename: &str) -> Result<(), XlsxError> {
    ...
    chart.set_axis_ids(43814272, 54517760);
    ...
    chart.y_axis().set_min(0);
    chart.y_axis().set_max(30);
    chart.x_axis().set_min(39083);
    chart.x_axis().set_max(39087);
...
#[test]
fn test_chart_axis14() {
    let test_runner = common::TestRunner::new()
        .set_name("chart_axis14")

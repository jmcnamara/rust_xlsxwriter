...
fn create_new_xlsx_file(filename: &str) -> Result<(), XlsxError> {
        ...
        .set_format(
            ChartFormat::new().set_pattern_fill(
                ChartPatternFill::new()
                    .set_pattern(ChartPatternFillType::Dotted40Percent)
    ...
    chart
        ...
        .set_format(
            ChartFormat::new().set_pattern_fill(
                ChartPatternFill::new()
                    .set_pattern(ChartPatternFillType::Dotted90Percent)
    ...
    chart
        ...
        .set_format(
            ChartFormat::new().set_pattern_fill(
                ChartPatternFill::new()
                    .set_pattern(ChartPatternFillType::DiagonalStripesWideUpwards)
    ...
    chart
        ...
        .set_format(
            ChartFormat::new().set_pattern_fill(
                ChartPatternFill::new()
                    .set_pattern(ChartPatternFillType::HorizontalStripesDark)
    ...
    chart
        ...
        .set_format(
            ChartFormat::new().set_pattern_fill(
                ChartPatternFill::new()
                    .set_pattern(ChartPatternFillType::LargeConfetti)
    ...
    chart
        ...
        .set_format(
            ChartFormat::new().set_pattern_fill(
                ChartPatternFill::new()
                    .set_pattern(ChartPatternFillType::Plaid)
    ...
    chart
        ...
        .set_format(
            ChartFormat::new().set_pattern_fill(
                ChartPatternFill::new()
                    .set_pattern(ChartPatternFillType::Sphere)
    ...
    chart
        ...
        .set_format(
            ChartFormat::new().set_pattern_fill(
                ChartPatternFill::new()
                    .set_pattern(ChartPatternFillType::SolidDiamondGrid)
...
#[test]
fn test_chart_pattern07() {
    let test_runner = common::TestRunner::new()
        .set_name("chart_pattern07")

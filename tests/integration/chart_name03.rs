...
fn create_new_xlsx_file(filename: &str) -> Result<(), XlsxError> {
    ...
    chart.set_axis_ids(44271104, 45703168);
    ...
    chart.set_name("New 1");

    worksheet.insert_chart(8, 4, &chart)?;

    chart.set_axis_ids(80928128, 80934400);
    chart.set_name("New 2");

    worksheet.insert_chart(23, 4, &chart)?;
...
#[test]
fn test_chart_name03() {
    let test_runner = common::TestRunner::new()
        .set_name("chart_name03")

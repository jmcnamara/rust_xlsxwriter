...
use crate::common;
use rust_xlsxwriter::{
    Chart, ChartFormat, ChartGradientFill, ChartGradientFillType, ChartGradientStop, ChartType,
    Workbook, XlsxError,
};
...
fn create_new_xlsx_file(filename: &str) -> Result<(), XlsxError> {
    ...
    chart.set_axis_ids(68936064, 68937600);
    chart
        .add_series()
        .set_values(("Sheet1", 0, 0, 4, 0))
        .set_invert_if_negative()
        .set_format(
            ChartFormat::new().set_gradient_fill(
                ChartGradientFill::new()
                    .set_type(ChartGradientFillType::Linear)
...
#[test]
fn test_chart_gradient07() {
    let test_runner = common::TestRunner::new()
        .set_name("chart_gradient07")

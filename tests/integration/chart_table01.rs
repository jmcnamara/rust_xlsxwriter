...
use crate::common;
use rust_xlsxwriter::{Chart, ChartSeries, ChartTable, ChartType, Workbook, XlsxError};
...
fn create_new_xlsx_file(filename: &str) -> Result<(), XlsxError> {
    ...
    let table = ChartTable::default();

    chart.set_table(&table);
...
#[test]
fn test_chart_table01() {
    let test_runner = common::TestRunner::new()
        .set_name("chart_table01")

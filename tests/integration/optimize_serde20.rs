...
#[test]
fn test_optimize_serde20_1() {
    let test_runner = common::TestRunner::new()
        .set_name("table07")
        .set_function(create_new_xlsx_file_1)
        .unique("optimize_serde20_1")
...
#[test]
fn test_optimize_serde20_2() {
    let test_runner = common::TestRunner::new()
        .set_name("table07")
        .set_function(create_new_xlsx_file_2)
        .unique("optimize_serde20_2")
        .ignore_worksheet_spans()
        .initialize();
...
#[test]
fn test_optimize_serde20_3() {
    let test_runner = common::TestRunner::new()
        .set_name("table07")
        .set_function(create_new_xlsx_file_3)
        .unique("optimize_serde20_3")
        .ignore_worksheet_spans()
        .initialize();

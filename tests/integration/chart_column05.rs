...
fn create_new_xlsx_file(filename: &str) -> Result<(), XlsxError> {
    ...
    chart
        .push_series(ChartSeries::new().set_values("=Foo!$A$1:$A$5"))
        .push_series(ChartSeries::new().set_values("=Foo!$B$1:$B$5"))
        .push_series(ChartSeries::new().set_values("=Foo!$C$1:$C$5"));
...
#[test]
fn test_chart_column05() {
    let test_runner = common::TestRunner::new()
        .set_name("chart_column05")

...
fn create_new_xlsx_file(filename: &str) -> Result<(), XlsxError> {
    ...
    chart.x_axis().set_min(0);
    chart.x_axis().set_max(20);

    // Category values should be ignored.
    chart.y_axis().set_min(111);
    chart.y_axis().set_max(999);
...
#[test]
fn test_chart_axis11() {
    let test_runner = common::TestRunner::new()
        .set_name("chart_axis11")

...
fn create_new_xlsx_file(filename: &str) -> Result<(), XlsxError> {
    ...
    chart.set_axis_ids(47711744, 47713280);
    chart
        .add_series()
        .set_values(("Sheet1", 0, 0, 4, 0))
        .set_format(ChartSolidFill::new().set_color("#FF0000"))
        .set_invert_if_negative()
        .set_invert_if_negative_color("#FFFF00");
...
#[test]
fn test_chart_axis52() {
    let test_runner = common::TestRunner::new()
        .set_name("chart_axis52")

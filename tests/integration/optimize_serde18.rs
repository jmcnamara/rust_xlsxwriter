...
#[test]
fn test_optimize_serde18_1() {
    let test_runner = common::TestRunner::new()
        .set_name("table01")
        .set_function(create_new_xlsx_file_1)
        .unique("optimize_serde18_1")
...
#[test]
fn test_optimize_serde18_2() {
    let test_runner = common::TestRunner::new()
        .set_name("table01")
        .set_function(create_new_xlsx_file_2)
        .unique("optimize_serde18_2")
        // Strings are duplicated because we add the table twice.
...
#[test]
fn test_optimize_serde18_3() {
    let test_runner = common::TestRunner::new()
        .set_name("table01")
        .set_function(create_new_xlsx_file_3)
        .unique("optimize_serde18_3")
        // Strings are duplicated because we add the table twice.
        .ignore_elements("xl/sharedStrings.xml", "count")
        .ignore_worksheet_spans()
        .initialize();
...
#[test]
fn test_optimize_serde18_4() {
    let test_runner = common::TestRunner::new()
        .set_name("table01")
        .set_function(create_new_xlsx_file_4)
        .unique("optimize_serde18_4")
        .ignore_worksheet_spans()
        .initialize();
...
#[test]
fn test_optimize_serde18_5() {
    let test_runner = common::TestRunner::new()
        .set_name("table01")
        .set_function(create_new_xlsx_file_5)
        .unique("optimize_serde18_5")
        .ignore_worksheet_spans()
        .initialize();

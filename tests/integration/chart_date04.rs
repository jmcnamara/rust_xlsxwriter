...
use crate::common;
use rust_xlsxwriter::{
    Chart, ChartAxisDateUnitType, ChartType, ExcelDateTime, Format, Workbook, XlsxError,
};
...
fn create_new_xlsx_file(filename: &str) -> Result<(), XlsxError> {
    ...
    chart.set_axis_ids(51761152, 51762688);
    ...
    chart
        .x_axis()
        .set_major_unit(1)
        .set_major_unit_date_type(ChartAxisDateUnitType::Years);
    chart
        .x_axis()
        .set_minor_unit(1)
        .set_minor_unit_date_type(ChartAxisDateUnitType::Months);
...
#[test]
fn test_chart_date04() {
    let test_runner = common::TestRunner::new()
        .set_name("chart_date04")

...
fn create_new_xlsx_file(filename: &str) -> Result<(), XlsxError> {
    ...
    chart1.set_axis2_ids(89510656, 84556032);
    ...
    chart1.y2_axis().set_position_between_ticks(false);
    chart1.x2_axis().set_position_between_ticks(false);
...
#[test]
fn test_chart_combined08() {
    let test_runner = common::TestRunner::new()
        .set_name("chart_combined08")

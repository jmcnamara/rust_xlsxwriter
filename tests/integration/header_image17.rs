...
fn create_new_xlsx_file(filename: &str) -> Result<(), XlsxError> {
    ...
    worksheet.set_header_image(&image1, HeaderImagePosition::Right)?;

    worksheet.set_footer("&L&G&C&G&R&G");
    worksheet.set_footer_image(&image2, HeaderImagePosition::Left)?;
    worksheet.set_footer_image(&image1, HeaderImagePosition::Center)?;
    worksheet.set_footer_image(&image2, HeaderImagePosition::Right)?;
...
#[test]
fn test_header_image17() {
    let test_runner = common::TestRunner::new()
        .set_name("header_image17")

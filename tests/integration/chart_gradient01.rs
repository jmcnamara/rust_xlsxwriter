...
fn create_new_xlsx_file_1(filename: &str) -> Result<(), XlsxError> {
    ...
    chart.set_axis_ids(61365248, 64275200);
    chart
        .add_series()
        .set_values(("Sheet1", 0, 0, 4, 0))
        .set_format(
            ChartFormat::new()
                .set_gradient_fill(ChartGradientFill::new().set_gradient_stops(&gradient_stops)),
        );
...
// Repeat test with IntoFormat trait.
...
#[test]
fn test_chart_gradient01_1() {
    let test_runner = common::TestRunner::new()
        .set_name("chart_gradient01")

...
fn create_new_xlsx_file(filename: &str) -> Result<(), XlsxError> {
    ...
    chart
        ...
        .format()
        .set_line(&ChartLine::new().set_color(XlsxColor::Theme(2, 0)));
    chart
        .add_series()
        .set_values(("Sheet1", 0, 1, 7, 1))
        .format()
        .set_line(&ChartLine::new().set_color(XlsxColor::Theme(2, 1)));
    chart
        .add_series()
        .set_values(("Sheet1", 0, 2, 7, 2))
        .format()
        .set_line(&ChartLine::new().set_color(XlsxColor::Theme(2, 2)));
    chart
        .add_series()
        .set_values(("Sheet1", 0, 3, 7, 3))
        .format()
        .set_line(&ChartLine::new().set_color(XlsxColor::Theme(2, 3)));
    chart
        .add_series()
        .set_values(("Sheet1", 0, 4, 7, 4))
        .format()
        .set_line(&ChartLine::new().set_color(XlsxColor::Theme(2, 4)));
    chart
        .add_series()
        .set_values(("Sheet1", 0, 5, 7, 5))
        .format()
        .set_line(&ChartLine::new().set_color(XlsxColor::Theme(2, 5)));

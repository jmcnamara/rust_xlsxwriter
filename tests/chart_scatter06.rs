...
fn create_new_xlsx_file(filename: &str) -> Result<(), XlsxError> {
    ...
    chart.x_axis().set_major_unit(3);
    chart.x_axis().set_minor_unit(1);

    chart.y_axis().set_major_unit(4.0);
    chart.y_axis().set_minor_unit(2.0);
...
#[test]
fn test_chart_scatter06() {
    let test_runner = common::TestRunner::new()
        .set_name("chart_scatter06")

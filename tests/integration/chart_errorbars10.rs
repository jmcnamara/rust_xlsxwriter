...
fn create_new_xlsx_file(filename: &str) -> Result<(), XlsxError> {
    ...
    chart.set_axis_ids(69198976, 69200896);
    chart
        .add_series()
        .set_categories(("Sheet1", 0, 0, 4, 0))
        .set_values(("Sheet1", 0, 1, 4, 1))
        .set_y_error_bars(ChartErrorBars::new().set_type(ChartErrorBarsType::Custom(
            ChartRange::new_from_string("Sheet1!$A$1"),
...
#[test]
fn test_chart_errorbars10() {
    let test_runner = common::TestRunner::new()
        .set_name("chart_errorbars10")

...
use rust_xlsxwriter::{
    Chart, ChartDataLabel, ChartFormat, ChartLine, ChartLineDashType, ChartPatternFill,
    ChartPatternFillType, ChartType, Workbook, XlsxError,
};
...
#[test]
fn test_chart_data_labels38() {
    let test_runner = common::TestRunner::new()
        .set_name("chart_data_labels38")

...
fn create_new_xlsx_file(filename: &str) -> Result<(), XlsxError> {
    ...
    let data_labels1 = vec![ChartDataLabel::new().set_value("31").to_custom()];

    let data_labels2 = vec![ChartDataLabel::new()
        .set_position(ChartDataLabelPosition::Center)
        .set_value("32")
        .to_custom()];

    let mut chart = Chart::new(ChartType::Column);
    chart.set_axis_ids(100378496, 100380032);
    ...
    chart
        ...
        .set_custom_data_labels(&data_labels1);
    ...
    chart
        ...
        .set_custom_data_labels(&data_labels2);
...
#[test]
fn test_chart_data_labels53() {
    let test_runner = common::TestRunner::new()
        .set_name("chart_data_labels53")

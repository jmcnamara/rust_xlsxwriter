...
use crate::common;
use rust_xlsxwriter::{
    Chart, ChartDataLabel, ChartFormat, ChartGradientFill, ChartGradientStop, ChartLine,
    ChartLineDashType, ChartType, Workbook, XlsxError,
};
        ...
        .set_data_label(
            ChartDataLabel::new().show_value().set_format(
                ChartFormat::new()
                    ...
                    .set_gradient_fill(
                        ChartGradientFill::new().set_gradient_stops(&gradient_stops),
                    ),
            ),
        );
...
#[test]
fn test_chart_data_labels39() {
    let test_runner = common::TestRunner::new()
        .set_name("chart_data_labels39")

...
use crate::common;
use rust_xlsxwriter::{Chart, ChartAxisLabelAlignment, ChartType, Workbook, XlsxError};
...
fn create_new_xlsx_file(filename: &str) -> Result<(), XlsxError> {
    ...
    chart
        .x_axis()
        .set_label_alignment(ChartAxisLabelAlignment::Right);
...
#[test]
fn test_chart_axis42() {
    let test_runner = common::TestRunner::new()
        .set_name("chart_axis42")

...
fn create_new_xlsx_file(filename: &str) -> Result<(), XlsxError> {
    ...
    chart.set_axis_ids(80553856, 80555392);
    chart
        .add_series()
    ...
    chart.set_axis_ids(84583936, 84585856);
    worksheet.insert_chart(24, 4, &chart)?;
...
#[test]
fn test_chart_format20() {
    let test_runner = common::TestRunner::new()
        .set_name("chart_format20")

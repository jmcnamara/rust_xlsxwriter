...
// Create a rust_xlsxwriter file to compare against an Excel file. Test default values.
...
// Create a rust_xlsxwriter file to compare against an Excel file. Test alternative method name.
